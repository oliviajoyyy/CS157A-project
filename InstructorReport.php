    ...
    img
{
    ...
    <h1>Instructor Report Table Database</h1>
                    <div class ="divin"><img src="https://contenthub-static.grammarly.com/blog/wp-content/uploads/2021/12/how-to-write-a-report.jpeg" alt="instructor reprot"> </div>
    ...
    <table>
        ...
        $sql = "SELECT * FROM InstructorReport ";
    ...
    <div>
        ...
        <thead>
        <tr>
            <th> <a href = "notNull.php"><button type="button">Taught Lessons</button></a></th>
        </tr>
          </thead>
    </table>
 </div>       
