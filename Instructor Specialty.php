...
<body>
    ...
    <div>
            <h1>Instructor Specialty Table Database</h1>
                   ...
                   <div class ="divin"><img src="https://cdn.mos.cms.futurecdn.net/fc342e536ccc0f99692c32171307b5fd.jpg" alt="BrianW"> </div>
    ...
    <div>
        <h2>Update Instructor Specialty Table Database</h2>
        <form action ="insert6.php" method="post">
            <label>Instructor ID:</label><input type = "text" name = "instructorID"><br>
            <label>Specialty:</label><input type = "text" name = "specialty"><br>  
    ...
    <div>
        <h2>Delete a Column in Instructor Specialty Table Database</h2>
